...
<html lang="en">
        <head>
            ...
            <script defer type="text/javascript" src="https://unpkg.com/tabulator-tables@5.4.4/dist/js/tabulator.min.js"></script>
            <script defer src="${pageContext.request.contextPath}/js/sticky.js"></script>
            <script defer src="${pageContext.request.contextPath}/js/admin/orders.js"></script>
            <title>Orders</title>
        </head>
            ...
            <section class="order-section">
                <div class="order-container">
                    <div class="order__content">
                        <h2 class="order__title">All Orders</h2>
                        <div class="order__header seven-cols">
                            ...
                            <span class="order__header-item">Customer</span>
                        </div>
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <c:forEach var="order" items="${orders}">
                                        <li class="order__item seven-cols" data-order-id="${order.id}">
                                            ...
                                            <span class="order__item-info">${order.customerName}</span>
                    ...
                    <div class="order__detail-wrapper hidden">
